		...
		<div class="main-wrapper">
			...
			<nav class="navbar navbar-expand-lg main-navbar">
				...
				<ul class="navbar-nav navbar-right">
					<li class="dropdown">
						<a href="<?= base_url('auth/logout'); ?>" class="nav-link nav-link-lg nav-link-user">
							<div class="d-sm-none d-lg-inline-block">Welcome, <?= $this->session->userdata('nama_customer'); ?> <span class="btn btn-sm btn-warning"> Logout </span></div>
			...
			<div class="main-sidebar">
				<aside id="sidebar-wrapper">
					...
					<ul class="sidebar-menu">
						...
						<li><a class="nav-link" href="<?= base_url('admin/data_tipe') ?>"><i class="fas fa-grip-horizontal"></i> <span>Data Tipe Mobil</span></a></li>
						...
						<li><a class="nav-link" href="<?= base_url('admin/laporan') ?>"><i class="fas fa-clipboard-list"></i> <span>Laporan Rental Mobil </span></a></li>

						<li><a class="nav-link" href="<?= base_url('auth/logout') ?>"><i class="fas fa-sign-out-alt"></i> <span> Logout </span></a></li>
						<li><a class="nav-link" href="<?= base_url('auth/ganti_password') ?>"><i class="fas fa-sign-out-alt"></i> <span> Ganti Password </span></a></li>
